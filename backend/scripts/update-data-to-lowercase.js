/**
 * Update Data to Lowercase Script
 * 
 * This script updates all enum data values to lowercase
 * to match the recreated enum types
 * 
 * Usage: node scripts/update-data-to-lowercase.js
 */
...
async function updateDataToLowercase() {
  console.log('=== UPDATING DATA TO LOWERCASE ===\n');
  ...
  try {
    ...
    console.log('✅ SUCCESS: All data has been updated to lowercase');
    console.log('\nNext steps:');
