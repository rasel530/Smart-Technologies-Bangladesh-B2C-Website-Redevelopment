 ...
 * Usage: node backend/create-admin.js <email> <password> <firstName> <lastName>
 * 
 * Examples:
 *   node backend/create-admin.js admin@smarttech.com AdminPassword123 "John" "Doe"
 *   node backend/create-admin.js admin@smarttech.com (auto-generates password)
 *   node backend/create-admin.js admin@smarttech.com MyPassword123 "Admin" "User"
 */
...
async function createAdmin(email, password = null, firstName = 'Admin', lastName = 'User') {
  ...
  try {
    ...
    if (!email || !email.includes('@')) {
      ...
      console.log('Usage: node backend/create-admin.js <email> [password] [firstName] [lastName]');
      console.log('Example: node backend/create-admin.js admin@smarttech.com AdminPassword123 "John" "Doe"');
      process.exit(1);
    }
    ...
    // Check if ADMIN role exists in RBAC roles table
...
if (!email) {
  ...
  console.log('  node backend/create-admin.js admin@smarttech.com AdminPassword123 "John" "Doe"');
  console.log('  node backend/create-admin.js admin@smarttech.com MyPassword123');
  console.log('  node backend/create-admin.js admin@smarttech.com');
  console.log('');
  process.exit(0);
}
