 ...
 * Page for Nagad mobile wallet payment processing
 */
...
import { NagadPayment } from '@/components/checkout/NagadPayment';
  ...
  return (
    <div className="payment-page-container">
      <div className="payment-page-header">
        <h1>Nagad Payment</h1>
        <p>Complete your payment using your Nagad mobile wallet</p>
      </div>
