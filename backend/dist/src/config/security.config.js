...
exports.getFraudDetectionRules = getFraudDetectionRules;
...
function getEnvironmentConfig() {
    ...
    switch (env) {
        case 'production':
            return { ...exports.securityConfig, ...exports.securityConfig.production };
        case 'test':
            return { ...exports.securityConfig, ...exports.securityConfig.test };
        case 'development':
        default:
            return { ...exports.securityConfig, ...exports.securityConfig.development };
    }
}
/**
...
function validateSecurityConfig() {
    ...
    if (!exports.securityConfig.pciDss.encryptionKey ||
        exports.securityConfig.pciDss.encryptionKey === 'default-key-change-in-production') {
    ...
    if (exports.securityConfig.webhook.verifySignatures) {
        for (const [gateway, config] of Object.entries(exports.securityConfig.webhook.gateways)) {
            if (!config.secret) {
    ...
    // Check rate limiting
    if (exports.securityConfig.rateLimiting.paymentInitiation.max < 1) {
        errors.push('Payment initiation rate limit must be at least 1');
    }
    // Check fraud detection
    if (exports.securityConfig.fraudDetection.riskThreshold < 0 ||
        exports.securityConfig.fraudDetection.riskThreshold > 100) {
 ...
 */
function getFraudDetectionRules() {
    return {
        maxTransactionsPerHour: exports.securityConfig.fraudDetection.maxTransactionsPerHour,
        maxTransactionsPerDay: exports.securityConfig.fraudDetection.maxTransactionsPerDay,
        maxTransactionAmount: exports.securityConfig.fraudDetection.maxTransactionAmount,
        maxFailedAttempts: exports.securityConfig.fraudDetection.maxFailedAttempts,
        suspiciousAmountPatterns: exports.securityConfig.fraudDetection.suspiciousAmountPatterns,
        suspiciousPhonePatterns: exports.securityConfig.fraudDetection.suspiciousPhonePatterns,
        blockedCountries: exports.securityConfig.fraudDetection.blockedCountries,
        suspiciousIPRanges: exports.securityConfig.fraudDetection.suspiciousIPRanges,
        trackDeviceId: exports.securityConfig.fraudDetection.trackDeviceId,
        trackIPHistory: exports.securityConfig.fraudDetection.trackIPHistory,
        suspiciousHours: exports.securityConfig.fraudDetection.suspiciousHours
    };
}
/**
...
function getRateLimitConfig(endpointType) {
    return exports.securityConfig.rateLimiting[endpointType] || exports.securityConfig.rateLimiting.api;
}
/**
...
function getWebhookSecret(gateway) {
    const gatewayConfig = exports.securityConfig.webhook.gateways[gateway.toLowerCase()];
