/**
 * Cleanup and Fix Enums Script
 * 
 * This script:
 * 1. Drops old enum types
 * 2. Updates data to use lowercase values
 * 
 * Usage: node scripts/cleanup-and-fix-enums.js
 */
...
async function cleanupAndFixEnums() {
  console.log('=== CLEANUP AND FIXING ENUMS ===\n');
  ...
  try {
    ...
    console.error('\n❌ Failed to cleanup and fix enums:', error.message);
