 ...
 * Page for Rocket mobile wallet payment processing
 * Note: Rocket is mapped to SSLCommerz gateway in backend
 */
  ...
  return (
    <div className="payment-page-container">
      <div className="payment-page-header">
        ...
        <p>Complete your payment using your Rocket mobile wallet</p>
      </div>
