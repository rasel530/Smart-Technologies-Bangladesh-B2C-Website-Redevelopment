-- =====================================================
-- WORKING DATABASE VERIFICATION TEST
-- =====================================================
-- Includes all required fields based on actual schema
...
INSERT INTO users (id, email, "firstName", "lastName", password, role, status, "createdAt", "updatedAt") 
VALUES ('test-user-1', 'test@example.com', 'Test', 'User', 'hashedpassword', 'CUSTOMER', 'ACTIVE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

-- READ
SELECT id, email, "firstName", "lastName", role, status FROM users WHERE id = 'test-user-1';

-- UPDATE
UPDATE users SET "firstName" = 'Updated', "updatedAt" = CURRENT_TIMESTAMP WHERE id = 'test-user-1';
...
-- Create test user
INSERT INTO users (id, email, "firstName", "lastName", password, role, status, "createdAt", "updatedAt") 
VALUES ('fk-test-user', 'fktest@example.com', 'FK', 'Test', 'hashedpassword', 'CUSTOMER', 'ACTIVE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
INSERT INTO products (id, sku, name, "nameEn", slug, "categoryId", "brandId", "regularPrice", "costPrice", "taxRate", "stockQuantity", "lowStockThreshold", status, "createdAt", "updatedAt") 
VALUES ('fk-test-prod', 'FK-TEST-PROD', 'FK Test Product', 'FK Test Product', 'fk-test-product', 'fk-test-cat', 'fk-test-brand', 100.00, 50.00, 0, 10, 5, 'ACTIVE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
INSERT INTO users (id, email, "firstName", "lastName", password, role, status, "createdAt", "updatedAt") 
VALUES ('unique-test-1', 'unique@example.com', 'Unique', 'Test1', 'hashedpassword', 'CUSTOMER', 'ACTIVE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
COMMIT;

-- Test not null constraints
BEGIN;
-- This should fail (email is required)
INSERT INTO users (id, "firstName", "lastName", password, role, status, "createdAt", "updatedAt") 
VALUES ('null-test-1', 'Null', 'Test', 'hashedpassword', 'CUSTOMER', 'ACTIVE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
ROLLBACK;
