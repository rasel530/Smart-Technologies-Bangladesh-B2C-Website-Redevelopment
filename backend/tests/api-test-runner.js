 ...
 * API Test Runner
 * 
 * This script runs all API endpoint tests for the Smart Technologies Bangladesh B2C Website.
 * It provides comprehensive testing coverage for all endpoints and generates detailed reports.
 */
...
const handleArguments = () => {
  ...
  switch (args[0]) {
    ...
    case '-h':
      ...
      printColor('Usage: node api-test-runner.js [options]', COLORS.bright);
    ...
    case '-f':
      if (args[1]) {
        ...
        printColor('Usage: node api-test-runner.js --file <test-file>', COLORS.yellow);
        process.exit(1);
      }
      break;
