/**
 * Simple test to verify critical fixes are working
 */
...
try {
  ...
  console.log('4. Testing emailService...');
  ...
  // Test 5: Check Twilio dependency
  console.log('5. Testing Twilio import...');
  const twilio = require('twilio');
  console.log('   ✓ Twilio imported successfully');
  console.log('   Twilio type:', typeof twilio);
  
  // Test 6: Check config service
  console.log('6. Testing config service...');
  const { configService } = require('./services/config');
  console.log('   ✓ configService imported successfully');
  
  // Test 7: Check logger service
  console.log('7. Testing logger service...');
