...
async function fixEnumsWithCascade() {
  console.log('=== FIXING ENUMS WITH CASCADE ===\n');

  try {
    // Step 1: Drop old enum types with CASCADE
    console.log('Step 1: Dropping old enum types with CASCADE...\n');
    ...
    console.log('\n✓ All old enum types dropped with CASCADE\n');
