 ...
 * Page for bKash mobile wallet payment processing
 */
...
import { BkashPayment } from '@/components/checkout/BkashPayment';
  ...
  return (
    <div className="payment-page-container">
      <div className="payment-page-header">
        <h1>bKash Payment</h1>
        <p>Complete your payment using your bKash mobile wallet</p>
      </div>
