/**
 * Test script to verify the GET /api/v1/admin/local-payment/methods endpoint
 * This script tests that the endpoint returns payment methods correctly
 */
...
console.log('LOCAL PAYMENT METHODS ENDPOINT TEST');
console.log('='.repeat(80));
