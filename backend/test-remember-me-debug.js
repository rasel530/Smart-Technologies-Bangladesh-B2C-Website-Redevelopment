...
const req = http.request(options, (res) => {
  ...
  res.on('end', () => {
    ...
    try {
      ...
      // Check all fields
      console.log('\n=== Response Analysis ===');
      console.log('Has rememberToken:', !!parsed.rememberToken);
      console.log('Has rememberMe:', !!parsed.rememberMe);
      console.log('rememberMe value:', parsed.rememberMe);
      ...
      if (parsed.rememberToken) {
        ...
        console.log('This means createRememberMeToken() is failing silently');
      }
    } catch (e) {
      console.log(data);
    }
