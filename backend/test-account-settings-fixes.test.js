 ...
 * 
 * Run with: node test-account-settings-fixes.test.js
 */
...
async function testVerificationModalCloseButton() {
  ...
  try {
    ...
    const hasCloseButton = componentCode.includes('onClick={handleCloseModal}') || 
                          componentCode.includes('onClick={() => setShowVerificationModal(false)}') ||
                          componentCode.includes('onClick={closeModal}');
    
    const hasModalState = componentCode.includes('showVerificationModal') || 
                          componentCode.includes('verificationModalOpen');
    
    const hasCloseFunction = componentCode.includes('handleCloseModal') || 
                             componentCode.includes('closeModal') ||
                             componentCode.includes('setShowVerificationModal(false)');
    ...
    const hasModalStructure = componentCode.includes('modal') || 
                             componentCode.includes('Modal') ||
                             componentCode.includes('dialog');
