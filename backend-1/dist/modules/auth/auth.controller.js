...
let AuthController = AuthController_1 = class AuthController {
    ...
    async changePassword(user, changePasswordDto) {
        try {
            const result = await this.authService.changePassword(user.id, changePasswordDto.currentPassword, changePasswordDto.newPassword);
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 401, description: 'Unauthorized' }),
    __param(0, (0, get_user_decorator_1.GetUser)('user')),
