-- ============================================================================
-- WISHLIST DATABASE TABLES FIX MIGRATION
-- ============================================================================
...
-- Rename columns in wishlist_analytics table from snake_case to camelCase
...
ALTER TABLE wishlists ADD COLUMN IF NOT EXISTS "isDefault" BOOLEAN DEFAULT false NOT NULL;
ALTER TABLE wishlists ADD COLUMN IF NOT EXISTS "isPublic" BOOLEAN DEFAULT false NOT NULL;
...
ALTER TABLE wishlists ADD COLUMN IF NOT EXISTS "shareToken" VARCHAR(64) UNIQUE;
