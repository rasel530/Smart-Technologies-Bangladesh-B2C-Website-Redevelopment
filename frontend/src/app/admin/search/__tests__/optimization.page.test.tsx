/**
 * Admin Search Optimization Page Tests
 * 
 * Comprehensive tests for admin search optimization page covering:
 * - Page rendering
 * - Loading state
 * - Error state
...
import AdminOptimizationPage from '../optimization/page';
import {
...
describe('Admin Search Optimization Page', () => {
  ...
  describe('Page Rendering', () => {
    it('should render the admin optimization page', () => {
      render(<AdminOptimizationPage />);

      expect(screen.getByText('Admin - Search Optimization')).toBeInTheDocument();
    });

    it('should render page title', () => {
      render(<AdminOptimizationPage />);

      expect(document.title).toContain('Admin - Search Optimization');
    });
